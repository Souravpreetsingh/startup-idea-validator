...
export default function HomePage() {
  ...
  return (
    <div className="bg-cream-paper text-midnight-ink font-body-md antialiased overflow-x-hidden min-h-screen">
      ...
      <header className="fixed top-[56px] md:top-[60px] left-1/2 -translate-x-1/2 w-[95%] max-w-7xl rounded-full px-6 py-3 bg-white/80 backdrop-blur-md border border-stone-mist flex justify-between items-center z-50">
        ...
        <nav className="hidden md:flex gap-8">
          <button onClick={() => router.push('/login')} className="text-on-surface-variant font-body-md text-body-md hover:text-primary transition-colors duration-200">Dashboard</button>
          <button onClick={() => router.push('/login')} className="text-primary font-bold border-b border-primary pb-1 font-body-md text-body-md hover:text-primary transition-colors duration-200">Analyze Idea</button>
          <button onClick={() => router.push('/login')} className="text-on-surface-variant font-body-md text-body-md hover:text-primary transition-colors duration-200">AI Assistant</button>
      ...
      <main className="pt-48 pb-[80px] px-[40px] max-w-7xl mx-auto relative flex flex-col items-center text-center min-h-[921px] justify-center">
      ...
      <section className="bg-stone-mist py-12 px-[40px] border-y border-outline-variant/30">
      ...
      <section className="py-[80px] px-[40px] max-w-7xl mx-auto">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          <h2 className="font-display-lg text-[40px] md:text-display-lg mb-6">Structural Intelligence</h2>
      ...
      <section className="border-t border-stone-mist">
        <div className="py-[80px] px-[40px] bg-cream-paper">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="h-64 border border-stone-mist rounded-xl bg-white p-6 relative overflow-hidden flex items-center justify-center">
              <span className="font-body-md text-graphite-veil italic">&ldquo;An AI tool that&hellip;&rdquo;</span>
            </div>
          </div>
        </div>
        <div className="py-[80px] px-[40px] bg-midnight-ink text-cream-paper">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-center">
